...
public class GameInputs : MonoBehaviour
{
    ...
    private static int[] KeyBoardInputsZero;

    private void Start()
    {
        SizeOfEnum = ButtonArrayIndex.GetNames(typeof(ButtonArrayIndex)).Length;

        KeyBoardInputsZero = new int[SizeOfEnum];

        for (int i = 0; i < SizeOfEnum; i++)
        {
            KeyBoardInputsZero[i] = 0;
        }
    ...
    */
    ...
    public static int GetKeyBoardInput(int buttonIndex)
    {
        ...
        return KeyBoardInputs[buttonIndex];
    }

    public static int[] GetKeyBoardInputsAllZero()
    {
        return KeyBoardInputsZero;
    }
